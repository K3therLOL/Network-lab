...
\begin{figure}[ht!]
    ...
    \label{fig:4_1_13}
\end{figure}
Не получилось, потому что в настройках маршрутизатора S\_R1 не был указан маршрут по умолчанию на маршрутизатор провайдера. После добавления маршрута по умолчанию на S\_R2 был сконфигурирован доступ только к подсети 192.168.1.0/24, где находится VPC5. Доступ к искомой подсети не был сконфигурирован.
\clearpage
